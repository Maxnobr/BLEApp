...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpButtons() {
        scan_button.setOnClickListener {       //Scanning is the action performed by the client
            getPairedDevices()
        ...
        connect_button.setOnClickListener {    //This button activates the App as the server
                    ...
                    try {
                        ...
                        when(msgString.toLowerCase().subSequence(0..4))
                        {
                            ...
                            "flash" ->
                            {
                                ...
                                Log.i(LOG_TAG,"else recieved ${msgString.toLowerCase().subSequence(0..4)}")
    ...
    companion object {
        ...
        private const val MY_UUID_STRING = "26957fac-b18a-4d2b-a8a5-6232e14e8d45"
